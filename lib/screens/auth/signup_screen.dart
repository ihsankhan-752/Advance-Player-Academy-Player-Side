...
import 'package:advance_player_academy_players/utils/all_text_controllers.dart';
import 'package:advance_player_academy_players/widgets/photo_upload_bottom_sheet.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              SizedBox(height: 20),
              CustomTextInput(controller: appTextController.usernameController, hintText: "Player Name"),
              SizedBox(height: 10),
