...
import 'package:advance_player_academy_players/screens/home/chat/widgets/chat_card.dart';
import 'package:advance_player_academy_players/screens/home/chat/widgets/chat_input_bottom.dart';
...
import '../../../utils/all_text_controllers.dart';
import '../../../widgets/custom_list_tile.dart';

class ChatMainScreen extends StatefulWidget {
  final String trainerId;
  const ChatMainScreen({super.key, required this.trainerId});
...
class _ChatMainScreenState extends State<ChatMainScreen> {
  ...
  @override
  void initState() {
    if (myId.hashCode > widget.trainerId.hashCode) {
      docId = myId + widget.trainerId;
    } else {
      docId = widget.trainerId + myId;
    }
    Provider.of<GetUserDetails>(context, listen: false).getTrainerDetail(widget.trainerId);
